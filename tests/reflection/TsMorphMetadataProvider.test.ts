...
import { Collection as Collection_, MikroORM, Reference as Reference_, ReferenceType, PrimaryProperty } from '@mikro-orm/core';
...
export type IdentifiedReference<T> = Reference<T> & Pick<T, PrimaryProperty<T> & keyof T>;
